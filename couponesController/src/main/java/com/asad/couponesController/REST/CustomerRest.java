...
public class CustomerRest implements CouponClaintREST {
	...
	public Response purchaseCoupon(@RequestBody RequestData customerData) throws CouponIsAlreadyPurchasedException,
			IdIsNullException, CustomerPurchaseDataException, IncomeIsNullException, NameIsUsedException,
			RequestDataIsNullException, NotLogedInException, ComponentNotFoundException {

		return incomeServices.storeIncome(customerData, ClientType.CUSTOMER, ActionType.PURCHASE);
	}

	@PostMapping("/listAllCustomerCoupons")
	public Response listAllCustomerCoupons(@RequestBody RequestData customerId)
	...
	public Response listCouponsByCouponTypeOrPrice(@RequestBody RequestData spesificCouponData)
			throws IdIsNullException, ComponentNotFoundException, NotLogedInException, RequestDataIsNullException {
