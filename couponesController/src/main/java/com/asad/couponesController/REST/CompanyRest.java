...
public class CompanyRest implements CouponClaintREST {
	...
	public synchronized Response logIn(@RequestBody LogIn logIn)
			throws LogInDataIsNullException, RequestDataIsNullException {
	...
	@Override
	public synchronized Response logout(@RequestBody RequestData IdData)
			throws IdIsNullException, RequestDataIsNullException, NotLogedInException {
	...
	public Response creatCoupon(@RequestBody RequestData couponData) throws NameIsUsedException // couponCreated
			, RequestDataIsNullException, NotLogedInException, CouponIsAlreadyPurchasedException, IncomeIsNullException,
			IdIsNullException, CustomerPurchaseDataException, ComponentNotFoundException {
	...
	public Response deleteCoupon(@RequestBody RequestData couponData)
			throws RequestDataIsNullException, NotLogedInException // couponDeleted
	{
	...
	public Response updateCoupon(@RequestBody RequestData couponData) throws RequestDataIsNullException,
			NotLogedInException, CouponIsAlreadyPurchasedException, IncomeIsNullException, NameIsUsedException,
			IdIsNullException, CustomerPurchaseDataException, ComponentNotFoundException {
	...
	public Response listAllCoupons(@RequestBody RequestData couponData)
	...
	public Response getCompanyIncome(@RequestBody RequestData companyData)
		...
		return new Response(companyServices.viewCompanyIncome(companyData));
